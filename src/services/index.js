...
export const CategoryList = (products) => {
    ...
    products.map((product) => {
        if (product.category_ids.length > 0 && product.category_ids) {
            product.category_ids.map((categorys) => {
...
export const GetsizeList = (products) => {
    var uniqueSizes = [];
    products.map((product) => {
        if (product.attributes.length > 0 && product.attributes) {
            product.attributes.map((sizes) => {
