...
//     super(props);
//     this.state = {
//       ActiveProductID: parseInt(this.props.match.params.slug),
//       pro: {},
...
//   }
//   componentDidMount() {
//     let slug = this.state.ActiveProductID;
//     axios.get(`http://127.0.0.1:8000/api/v1/products/details/${slug}`)
//       .then(res => {
//         const pro = res.data;
...
//                               <img className="img-fluid w-100" src={require(`../../../assets/images/${image}`).default} alt="" />
//                             </div>
//                           )
//                         })}
//                       </OwlCarousel>
...
//                                 <img className="img-fluid w-100" src={require(`../../../assets/images/${SelectedProduct.pictures[0]}`).default} alt="" />
//                               </div>
...
//                           <img className="card-img-top card-img-back" src={require(`../../../assets/images/product/main/02.jpg`).default} alt="..." />
//                           <img className="card-img-top card-img-front" src={require(`../../../assets/images/product/main/01.jpg`).default} alt="..." />
//                         </Link>
...
//                         </button>
//                         <Link className="card-img-hover d-block" to="/product-single-left/Woman/1">
//                           <img className="card-img-top card-img-back" src={require(`../../../assets/images/product/main/12.jpg`).default} alt="..." />
//                           <img className="card-img-top card-img-front" src={require(`../../../assets/images/product/main/11.jpg`).default} alt="..." />
//                         </Link>
//                         <div className="card-info">
//                           <div className="card-body">
...
//                         </button>
//                         <Link className="card-img-hover d-block" to="/product-single-left/Woman/1">
//                           <img className="card-img-top card-img-back" src={require(`../../../assets/images/product/main/14.jpg`).default} alt="..." />
//                           <img className="card-img-top card-img-front" src={require(`../../../assets/images/product/main/13.jpg`).default} alt="..." />
//                         </Link>
//                         <div className="card-info">
//                           <div className="card-body">
...
//                         </button>
//                         <Link className="card-img-hover d-block" to="/product-single-left/Woman/1">
//                           <img className="card-img-top card-img-back" src={require(`../../../assets/images/product/main/10.jpg`).default} alt="..." />
//                           <img className="card-img-top card-img-front" src={require(`../../../assets/images/product/main/09.jpg`).default} alt="..." />
//                         </Link>
//                         <div className="card-info">
//                           <div className="card-body">
