                ...
                <Container>
                    <Row>
                        <div className="col-12 col-lg-3">
                            ...
                            <p className="my-3 text-muted">Multi-purpose E-commerce Html5 Template Is fully responsible, Build whatever you like with the Ekocart, Ekocart is the creative, modern HTML5 Template suitable for Your business.</p>
                            ...
                            <Row>
                                <div className="col-12 col-sm-4 navbar-dark">
                                    ...
                                    <ul className="navbar-nav list-unstyled mb-0">
                                        ...
                                        <li className="mb-3 nav-item"><Link className="nav-link" to="/">About</Link>
                                        </li>
                    ...
                    <Row className="text-muted align-items-center">
                        <Col md={7}>Copyright 2021 All rights reserved | This app is made by <i className="lar la-heart text-primary heartBeat2" />  <u><Link className="text-primary" to="#">Evertech IT</Link></u>
                        </Col>
